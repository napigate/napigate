...
```dotenv
NAPIGATE_IMAGE=your-dockerhub-username/napigate:0.1.3
...
```bash
docker login
NAPIGATE_IMAGE=your-dockerhub-username/napigate:0.1.3 docker compose -f docker-compose.yml -f docker-compose.build.yml build app
NAPIGATE_IMAGE=your-dockerhub-username/napigate:0.1.3 docker compose -f docker-compose.yml -f docker-compose.build.yml push app
```
